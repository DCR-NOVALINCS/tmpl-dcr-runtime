...
This tutorial will guide you through the process of creating and executing a DCR graph with templates using the interpreter.
...
- [`9-template-applications`](9-template-applications/README.md)
- [`10-control-flow-annotations`](10-control-flow-annotations/README.md)
